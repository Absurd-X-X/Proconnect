...
{
    /// <inheritdoc />
    public partial class ChangesDueToRecruiterModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvitationCode = table.Column<string>(type: "longtext", nullable: true),
                    InvitationCodeExpiry = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePicturePublicId = table.Column<string>(type: "longtext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResumePublicId = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                    ResumeViewCount = table.Column<int>(type: "int", nullable: false),
                    ResumeDownloadCount = table.Column<int>(type: "int", nullable: false),
                    UserStatus = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    PreferredJobTypes = table.Column<string>(type: "longtext", nullable: false),
                    PreferredLocations = table.Column<string>(type: "longtext", nullable: false),
                    EarliestStartDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    WillingToRelocate = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    WorkAuthorization = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    AvailabilityVisibility = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    DateModified = table.Column<DateTime>(type: "datetime(6)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailPublicId = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioLinks_ProfessionalProfiles_ProfessionalProfileId",
                        column: x => x.ProfessionalProfileId,
                        principalTable: "ProfessionalProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b235f2ed-bb4e-4bd2-a03d-0e3c17aaf2e2"), "c117635d-96e0-409b-9fae-72976ec9c42a", new DateTime(2026, 8, 13, 5, 47, 49, 656, DateTimeKind.Utc).AddTicks(4945), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "Soulshelf Group Chat" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Bio", "CreatedBy", "DateCreated", "DateModified", "Email", "FirstName", "HashedPassword", "IsActive", "IsDeleted", "IsVerified", "LastName", "Location", "PasswordResetToken", "PasswordResetTokenExpiry", "ProfilePicturePublicId", "ProfilePictureUrl", "RefreshToken", "RefreshTokenExpiry", "Role", "Tel", "UserName", "VerificationToken", "VerificationTokenExpiry" },
                values: new object[] { "c117635d-96e0-409b-9fae-72976ec9c42a", "I am the administrator of this platform.", "system", new DateTime(2026, 8, 13, 5, 47, 49, 575, DateTimeKind.Utc).AddTicks(8459), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", "Ajibike", "AQAAAAIAAYagAAAAEPNEImM+64fT1vZnS2O3YRM05aOKeFuso+Tazydf8qTEq/kI4mtTRnv1FmeDuWthnA==", true, false, true, "Abdussomad", "Ogun State, Nigeria", null, null, null, null, null, null, "admin", null, "Administrator", null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PortfolioLinks_ProfessionalProfileId",
